...
export function Viz(props: { vizualization: ReactElement; code: string; title: string }) {
  ...
  return (
    <>
      ...
      <div className="snippet-container text">
        <div className="snippet-codeblock"><CodeBlock language={"javascript"}>{code}</CodeBlock></div>
      </div>
    </>
  );
}
